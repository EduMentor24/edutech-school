-- Informatique / TICE Terminale : fondations du numérique et citoyenneté responsable.
...
begin
  select count(*) into offering_count from public.course_subject_offerings where id in ($computer_science$0beafff1-63db-42c9-99a2-8ef6da799f19$computer_science$,$computer_science$7680fb4a-c9d4-41df-92f3-a91effda4944$computer_science$,$computer_science$7695b4cf-0524-4de4-af91-f8d79eed2b0a$computer_science$,$computer_science$f9c030a4-8b30-4657-b7bb-d81e4e500635$computer_science$) and is_test_data=false;
  ...
  if exists (
    ...
    where c.subject_offering_id in ($computer_science$0beafff1-63db-42c9-99a2-8ef6da799f19$computer_science$,$computer_science$7680fb4a-c9d4-41df-92f3-a91effda4944$computer_science$,$computer_science$7695b4cf-0524-4de4-af91-f8d79eed2b0a$computer_science$,$computer_science$f9c030a4-8b30-4657-b7bb-d81e4e500635$computer_science$)
      and c.title=$computer_science$Fondations du numérique et citoyenneté responsable$computer_science$
  ) then
  ...
  if exists (
    ...
    where c.subject_offering_id in ($computer_science$0beafff1-63db-42c9-99a2-8ef6da799f19$computer_science$,$computer_science$7680fb4a-c9d4-41df-92f3-a91effda4944$computer_science$,$computer_science$7695b4cf-0524-4de4-af91-f8d79eed2b0a$computer_science$,$computer_science$f9c030a4-8b30-4657-b7bb-d81e4e500635$computer_science$)
      and l.title=$computer_science$Comprendre son environnement numérique, ses données et ses choix responsables$computer_science$
  ) then
  ...
  for target in
    ...
    where o.id in ($computer_science$0beafff1-63db-42c9-99a2-8ef6da799f19$computer_science$,$computer_science$7680fb4a-c9d4-41df-92f3-a91effda4944$computer_science$,$computer_science$7695b4cf-0524-4de4-af91-f8d79eed2b0a$computer_science$,$computer_science$f9c030a4-8b30-4657-b7bb-d81e4e500635$computer_science$)
  ...
  loop
    ...
    values (target.subject_id,target.level_id,target.series_id,target.offering_id,$computer_science$Fondations du numérique et citoyenneté responsable$computer_science$,'Parcours complémentaire non officiel : repères de culture numérique, de responsabilité et de raisonnement par étapes.',chapter_order,false,false)
    ...
    values (target_chapter_id,$computer_science$Comprendre son environnement numérique, ses données et ses choix responsables$computer_science$,'Leçon d’initiation complémentaire : appareils, logiciels, données, vérification de l’information, sécurité de base, raisonnement algorithmique et usage responsable de l’IA.',$computer_science$# Informatique / TICE — Parcours d’initiation Terminale
...
> **Trace du parcours :** le contenu est une création pédagogique originale pour EduTech School, conçue comme une initiation non officielle et évolutive. Il ne remplace pas un programme national ni les consignes de l’enseignant.$computer_science$,lesson_order,false,false)
...
(exercise_environment_id,'single_choice',$computer_science$Un clavier appartient surtout à quelle catégorie ?$computer_science$,jsonb_build_array($computer_science$Matériel$computer_science$,$computer_science$Application$computer_science$,$computer_science$Donnée personnelle$computer_science$),jsonb_build_array($computer_science$Matériel$computer_science$),$computer_science$Un clavier est un objet physique utilisé pour saisir des informations : c’est du matériel.$computer_science$,10),
(exercise_environment_id,'single_choice',$computer_science$Quel nom de fichier aide le mieux un groupe à retrouver un plan d’exposé révisé ?$computer_science$,jsonb_build_array($computer_science$nouveau_final2$computer_science$,$computer_science$plan_expose_eau_version_revue$computer_science$,$computer_science$document$computer_science$),jsonb_build_array($computer_science$plan_expose_eau_version_revue$computer_science$),$computer_science$Un bon nom donne le sujet et l’état de la version sans avoir besoin d’ouvrir le fichier.$computer_science$,20),
(exercise_environment_id,'single_choice',$computer_science$Quelle donnée ne doit pas être envoyée dans un groupe de classe ?$computer_science$,jsonb_build_array($computer_science$Un lien vers une source publique$computer_science$,$computer_science$Un mot de passe ou un code de validation$computer_science$,$computer_science$Le titre d’un exposé$computer_science$),jsonb_build_array($computer_science$Un mot de passe ou un code de validation$computer_science$),$computer_science$Un mot de passe et un code de validation donnent accès à un compte : ils doivent rester confidentiels.$computer_science$,30),
(exercise_environment_id,'single_choice',$computer_science$Quelle action permet de mieux évaluer une information en ligne ?$computer_science$,jsonb_build_array($computer_science$Lire seulement le titre$computer_science$,$computer_science$Vérifier l’auteur, la date et une autre source pertinente$computer_science$,$computer_science$Partager immédiatement si l’image semble convaincante$computer_science$),jsonb_build_array($computer_science$Vérifier l’auteur, la date et une autre source pertinente$computer_science$),$computer_science$La vérification croise l’origine, le contexte et les preuves ; elle ne se limite pas à l’apparence d’un contenu.$computer_science$,40);
...
insert into public.exercise_questions (exercise_id,question_type,prompt_markdown,options,correct_answers,explanation_markdown,display_order) values
(exercise_decisions_id,'single_choice',$computer_science$Dans une procédure de remise de devoir, quelle étape doit précéder l’envoi ?$computer_science$,jsonb_build_array($computer_science$Vérifier le bon fichier et le destinataire$computer_science$,$computer_science$Donner son mot de passe à un camarade$computer_science$,$computer_science$Renommer tous les fichiers « final »$computer_science$),jsonb_build_array($computer_science$Vérifier le bon fichier et le destinataire$computer_science$),$computer_science$Cette vérification réduit les erreurs d’envoi et protège les documents qui ne doivent pas être transmis.$computer_science$,10),
(exercise_decisions_id,'single_choice',$computer_science$Un message contient une affirmation sans auteur, sans date et sans source. Quelle formulation est responsable ?$computer_science$,jsonb_build_array($computer_science$C’est forcément vrai car le message est populaire.$computer_science$,$computer_science$Cette information doit être vérifiée avant d’être utilisée ou partagée.$computer_science$,$computer_science$Il faut la publier vite pour avertir tout le monde.$computer_science$),jsonb_build_array($computer_science$Cette information doit être vérifiée avant d’être utilisée ou partagée.$computer_science$),$computer_science$L’absence d’éléments vérifiables ne prouve pas qu’une affirmation est fausse, mais impose de la prudence.$computer_science$,20),
(exercise_decisions_id,'single_choice',$computer_science$Laquelle de ces descriptions contient une condition utile ?$computer_science$,jsonb_build_array($computer_science$Ouvre le fichier.$computer_science$,$computer_science$Si le fichier ne s’ouvre pas, vérifie son emplacement ou demande de l’aide.$computer_science$,$computer_science$Le fichier est intéressant.$computer_science$),jsonb_build_array($computer_science$Si le fichier ne s’ouvre pas, vérifie son emplacement ou demande de l’aide.$computer_science$),$computer_science$Une condition décrit ce qu’il faut faire dans une situation particulière ; elle rend une procédure plus fiable.$computer_science$,30),
(exercise_decisions_id,'single_choice',$computer_science$Quel usage d’un outil d’IA respecte la responsabilité de l’élève ?$computer_science$,jsonb_build_array($computer_science$Copier une réponse sans la lire$computer_science$,$computer_science$L’utiliser pour obtenir des pistes, puis vérifier et reformuler avec ses propres connaissances$computer_science$,$computer_science$Lui transmettre des identifiants pour qu’il fasse le devoir$computer_science$),jsonb_build_array($computer_science$L’utiliser pour obtenir des pistes, puis vérifier et reformuler avec ses propres connaissances$computer_science$),$computer_science$L’outil peut aider, mais l’élève reste responsable de la compréhension, des choix et de la vérification du résultat.$computer_science$,40);

insert into public.quizzes (subject_id,level_id,series_id,subject_offering_id,chapter_id,lesson_id,title,description,difficulty,duration_minutes,display_order,is_published,is_active,is_test_data) values (target.subject_id,target.level_id,target.series_id,target.offering_id,target_chapter_id,target_lesson_id,$computer_science$Quiz 1 — Vocabulaire de l’environnement numérique$computer_science$,$computer_science$Vérifie la compréhension du matériel, des logiciels, des fichiers et des données à protéger.$computer_science$,'easy',12,10,false,false,false) returning id into quiz_environment_id; with inserted_questions as (insert into public.quiz_questions (quiz_id,question,explanation,question_type,display_order,points,is_active) values (quiz_environment_id,$computer_science$Quel élément est un logiciel de base qui organise l’appareil ?$computer_science$,$computer_science$Le système d’exploitation organise le fonctionnement général de l’appareil et l’accès aux applications.$computer_science$,'single_choice',10,1,true),
(quiz_environment_id,$computer_science$Quelle phrase définit le mieux une donnée ?$computer_science$,$computer_science$Une donnée est une information manipulée, stockée, consultée ou transmise dans un contexte numérique.$computer_science$,'single_choice',20,1,true),
(quiz_environment_id,$computer_science$Pourquoi créer des dossiers pour un travail scolaire ?$computer_science$,$computer_science$Une organisation par dossiers facilite la recherche, le partage contrôlé et la distinction entre brouillons et version finale.$computer_science$,'single_choice',30,1,true),
(quiz_environment_id,$computer_science$Quel exemple est une donnée confidentielle ?$computer_science$,$computer_science$Un code de connexion peut permettre l’accès à un compte ; il ne doit donc pas être partagé.$computer_science$,'single_choice',40,1,true) returning id,display_order) insert into public.quiz_answers (question_id,answer,is_correct,display_order) select iq.id,v.answer,v.is_correct,v.display_order from inserted_questions iq join (values (10,$computer_science$Le système d’exploitation$computer_science$,true,10),
(10,$computer_science$Le clavier$computer_science$,false,20),
(10,$computer_science$Une photo$computer_science$,false,30),
(20,$computer_science$Une information utilisée ou enregistrée$computer_science$,true,10),
(20,$computer_science$Seulement un appareil$computer_science$,false,20),
(20,$computer_science$Toujours un mot de passe$computer_science$,false,30),
(30,$computer_science$Pour retrouver et classer les fichiers$computer_science$,true,10),
(30,$computer_science$Pour effacer toute version$computer_science$,false,20),
(30,$computer_science$Pour remplacer la vérification$computer_science$,false,30),
(40,$computer_science$Un code de validation$computer_science$,true,10),
(40,$computer_science$Le titre d’un exposé$computer_science$,false,20),
(40,$computer_science$Un dossier de révision vide$computer_science$,false,30)) as v(question_order,answer,is_correct,display_order) on v.question_order=iq.display_order;
insert into public.quizzes (subject_id,level_id,series_id,subject_offering_id,chapter_id,lesson_id,title,description,difficulty,duration_minutes,display_order,is_published,is_active,is_test_data) values (target.subject_id,target.level_id,target.series_id,target.offering_id,target_chapter_id,target_lesson_id,$computer_science$Quiz 2 — Choix responsables et raisonnement par étapes$computer_science$,$computer_science$Vérifie les gestes de vérification, les consignes précises et l’usage responsable des aides numériques.$computer_science$,'easy',12,20,false,false,false) returning id into quiz_decisions_id; with inserted_questions as (insert into public.quiz_questions (quiz_id,question,explanation,question_type,display_order,points,is_active) values (quiz_decisions_id,$computer_science$Quelle question aide à vérifier une information ?$computer_science$,$computer_science$Identifier l’auteur et la date aide à comprendre l’origine et le contexte d’une information.$computer_science$,'single_choice',10,1,true),
(quiz_decisions_id,$computer_science$Quelle propriété caractérise une bonne consigne algorithmique ?$computer_science$,$computer_science$Une instruction est utile lorsqu’elle est claire, ordonnée, réalisable et permet un contrôle du résultat.$computer_science$,'single_choice',20,1,true),
(quiz_decisions_id,$computer_science$Que faut-il faire avant d’envoyer un fichier ?$computer_science$,$computer_science$Le contrôle du document et du destinataire évite de remettre un mauvais fichier ou une information non destinée à la bonne personne.$computer_science$,'single_choice',30,1,true),
(quiz_decisions_id,$computer_science$Quelle affirmation sur une réponse générée automatiquement est correcte ?$computer_science$,$computer_science$Une réponse automatique peut être utile, mais elle doit être comprise, vérifiée et comparée à des sources adaptées.$computer_science$,'single_choice',40,1,true) returning id,display_order) insert into public.quiz_answers (question_id,answer,is_correct,display_order) select iq.id,v.answer,v.is_correct,v.display_order from inserted_questions iq join (values (10,$computer_science$Qui publie et quand ?$computer_science$,true,10),
(10,$computer_science$Est-ce que le titre est court ?$computer_science$,false,20),
(10,$computer_science$Est-ce que je l’ai déjà vue ?$computer_science$,false,30),
(20,$computer_science$Elle est précise et ordonnée$computer_science$,true,10),
(20,$computer_science$Elle reste vague$computer_science$,false,20),
(20,$computer_science$Elle ne prévoit aucun contrôle$computer_science$,false,30),
(30,$computer_science$Vérifier le fichier et le destinataire$computer_science$,true,10),
(30,$computer_science$Partager les identifiants$computer_science$,false,20),
(30,$computer_science$Choisir le premier fichier affiché$computer_science$,false,30),
(40,$computer_science$Elle doit être vérifiée avant d’être utilisée$computer_science$,true,10),
(40,$computer_science$Elle est toujours exacte$computer_science$,false,20),
(40,$computer_science$Elle remplace le jugement de l’élève$computer_science$,false,30)) as v(question_order,answer,is_correct,display_order) on v.question_order=iq.display_order;
  end loop;
