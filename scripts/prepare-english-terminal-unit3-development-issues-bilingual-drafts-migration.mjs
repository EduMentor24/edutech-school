...
const migrationPath = resolve(root, "supabase/migrations/20260823_english_terminal_unit3_development_issues_bilingual_drafts.sql");
const payloadPath = resolve(root, "supabase/migrations/20260823_english_terminal_unit3_development_issues_bilingual_drafts.apply.json");
...
const lessonContent = `## Unit 3 — Development Issues
...
Reformulated and expanded from the supplied PDFs: **Unit 3 Development Issues — Reading for Comprehension**, Far Ahead Terminale, pages 32–33, and **Unit 3 Development Issues — Writing an Article**, École numérique, Côte d’Ivoire.`;

const readingQuestions = [
  ["**What is the general idea of the supplied reading activity?**\n\n> **Traduction française :** Quelle est l’idée générale de l’activité de lecture fournie ?", ["Child marriage, its causes and drawbacks\n— Traduction française : Le mariage des enfants, ses causes et ses conséquences négatives", "A cooking competition\n— Traduction française : Un concours de cuisine", "A sports match\n— Traduction française : Un match de sport"], ["Child marriage, its causes and drawbacks\n— Traduction française : Le mariage des enfants, ses causes et ses conséquences négatives"], "**The learning context explicitly says that the text is about child brides, the causes of child marriage and its drawbacks.**\n\n> **Traduction française :** Le contexte d’apprentissage indique explicitement que le texte porte sur les jeunes mariées, les causes du mariage des enfants et ses conséquences négatives."],
  ["**Which vocabulary answer is explicitly provided by the worksheet?**\n\n> **Traduction française :** Quelle réponse de vocabulaire est explicitement fournie par la fiche ?", ["new married woman or girl → bride\n— Traduction française : nouvelle femme ou fille mariée → bride / mariée", "reach → flood\n— Traduction française : reach → flood / atteindre → inondation", "perception → school\n— Traduction française : perception → school / perception → école"], ["new married woman or girl → bride\n— Traduction française : nouvelle femme ou fille mariée → bride / mariée"], "**The worksheet gives “bride” as the model answer for a new married woman or girl.**\n\n> **Traduction française :** La fiche donne « bride » comme réponse modèle pour une nouvelle femme ou fille mariée."],
  ["**What must you do after choosing true or false?**\n\n> **Traduction française :** Que dois-tu faire après avoir choisi vrai ou faux ?", ["Justify with the relevant line(s)\n— Traduction française : Justifier avec la ou les lignes pertinentes", "Write a new story\n— Traduction française : Écrire une nouvelle histoire", "Ignore the text\n— Traduction française : Ignorer le texte"], ["Justify with the relevant line(s)\n— Traduction française : Justifier avec la ou les lignes pertinentes"], "**The source requires learners to justify true-or-false decisions by quoting the lines.**\n\n> **Traduction française :** La source exige que les élèves justifient les décisions vrai/faux en citant les lignes."],
  ["**What is the responsible way to mention an unknown legal age?**\n\n> **Traduction française :** Quelle est la manière responsable de mentionner un âge légal inconnu ?", ["Say it must be checked in a reliable official source.\n— Traduction française : Dire qu’il doit être vérifié dans une source officielle fiable.", "Invent a number.\n— Traduction française : Inventer un nombre.", "Repeat a rumour.\n— Traduction française : Répéter une rumeur."], ["Say it must be checked in a reliable official source.\n— Traduction française : Dire qu’il doit être vérifié dans une source officielle fiable."], "**Legal facts must be verified; a human-rights discussion must not turn a guess into a fact.**\n\n> **Traduction française :** Les faits juridiques doivent être vérifiés ; une discussion sur les droits humains ne doit pas transformer une supposition en fait."],
];

const writingQuestions = [
  ["**What genre does the Writing PDF teach?**\n\n> **Traduction française :** Quel genre le PDF Writing enseigne-t-il ?", ["An article\n— Traduction française : Un article", "An informal letter\n— Traduction française : Une lettre informelle", "A dialogue only\n— Traduction française : Un dialogue uniquement"], ["An article\n— Traduction française : Un article"], "**The Writing PDF is titled “Writing an Article”.**\n\n> **Traduction française :** Le PDF Writing est intitulé « Writing an Article »."],
  ["**Which part belongs at the beginning of an article?**\n\n> **Traduction française :** Quelle partie se place au début d’un article ?", ["A title and an introduction\n— Traduction française : Un titre et une introduction", "A signature to a friend\n— Traduction française : Une signature à un ami", "A random conclusion\n— Traduction française : Une conclusion au hasard"], ["A title and an introduction\n— Traduction française : Un titre et une introduction"], "**The source checks that an article begins with a title and has an introduction, main body and conclusion.**\n\n> **Traduction française :** La source vérifie qu’un article commence par un titre et possède une introduction, un développement et une conclusion."],
  ["**What should the paragraph about threats explain?**\n\n> **Traduction française :** Que doit expliquer le paragraphe sur les menaces ?", ["Why the lifestyle is under threat today\n— Traduction française : Pourquoi le mode de vie est menacé aujourd’hui", "Only the writer’s birthday\n— Traduction française : Seulement l’anniversaire de l’auteur", "A greeting formula\n— Traduction française : Une formule de salutation"], ["Why the lifestyle is under threat today\n— Traduction française : Pourquoi le mode de vie est menacé aujourd’hui"], "**One source heading is “reason why this lifestyle is under threat today”.**\n\n> **Traduction française :** L’un des titres source est « raison pour laquelle ce mode de vie est menacé aujourd’hui »."] ,
  ["**How many words does the source ask you to write?**\n\n> **Traduction française :** Combien de mots la source demande-t-elle d’écrire ?", ["250 to 300 words\n— Traduction française : 250 à 300 mots", "20 words\n— Traduction française : 20 mots", "1,000 words\n— Traduction française : 1 000 mots"], ["250 to 300 words\n— Traduction française : 250 à 300 mots"], "**The communicative activity asks for an article of 250 to 300 words.**\n\n> **Traduction française :** L’activité communicative demande un article de 250 à 300 mots."],
  ["**Which solution is responsible in an article about threatened heritage?**\n\n> **Traduction française :** Quelle solution est responsable dans un article sur un patrimoine menacé ?", ["Listen to local voices and propose fair, feasible protection.\n— Traduction française : Écouter les voix locales et proposer une protection équitable et réalisable.", "Ignore the people concerned.\n— Traduction française : Ignorer les personnes concernées.", "Invent unsupported statistics.\n— Traduction française : Inventer des statistiques non étayées."], ["Listen to local voices and propose fair, feasible protection.\n— Traduction française : Écouter les voix locales et proposer une protection équitable et réalisable."], "**A responsible article respects dignity, evidence and the participation of the people concerned.**\n\n> **Traduction française :** Un article responsable respecte la dignité, les preuves et la participation des personnes concernées."],
];

const readingQuiz = [
  ["**What should a prediction from a map be before reading?**\n\n> **Traduction française :** Que doit être une anticipation à partir d’une carte avant de lire ?", "**It should be a question or hypothesis to confirm, not an invented conclusion.**\n\n> **Traduction française :** Elle doit être une question ou une hypothèse à confirmer, et non une conclusion inventée.", [["A hypothesis to confirm\n— Traduction française : Une hypothèse à confirmer", true], ["A certain fact without reading\n— Traduction française : Un fait certain sans lire", false], ["A personal insult\n— Traduction française : Une insulte personnelle", false]]],
  ["**What does a general idea avoid?**\n\n> **Traduction française :** Qu’est-ce qu’une idée générale évite ?", "**It avoids becoming a list of every detail.**\n\n> **Traduction française :** Elle évite de devenir une liste de tous les détails.", [["A list of every detail\n— Traduction française : Une liste de tous les détails", true], ["The central issue\n— Traduction française : Le problème central", false], ["A neutral summary\n— Traduction française : Un résumé neutre", false]]],
  ["**Which clue helps you find vocabulary in context?**\n\n> **Traduction française :** Quel indice t’aide à trouver le vocabulaire en contexte ?", "**The paragraph number, grammar and surrounding words are useful clues.**\n\n> **Traduction française :** Le numéro du paragraphe, la grammaire et les mots environnants sont des indices utiles.", [["Paragraph number and context\n— Traduction française : Numéro du paragraphe et contexte", true], ["Only the font colour\n— Traduction française : Seulement la couleur de police", false], ["No reading at all\n— Traduction française : Aucune lecture", false]]],
  ["**Why can a true-or-false statement be false even if it sounds similar to the text?**\n\n> **Traduction française :** Pourquoi une affirmation vrai/faux peut-elle être fausse même si elle ressemble au texte ?", "**One changed key fact, such as a country, number, age or cause, can make it false.**\n\n> **Traduction française :** Un seul fait clé modifié, comme un pays, un nombre, un âge ou une cause, peut la rendre fausse.", [["A key fact may have changed\n— Traduction française : Un fait clé peut avoir été modifié", true], ["All similar sentences are automatically true\n— Traduction française : Toutes les phrases semblables sont automatiquement vraies", false], ["Evidence is unnecessary\n— Traduction française : La preuve est inutile", false]]],
];

const writingQuiz = [
  ["**What is an article’s main purpose in this task?**\n\n> **Traduction française :** Quel est le but principal d’un article dans cette tâche ?", "**It informs readers about an issue and proposes responsible solutions.**\n\n> **Traduction française :** Il informe les lecteurs sur un problème et propose des solutions responsables.", [["Inform and propose solutions\n— Traduction française : Informer et proposer des solutions", true], ["Write private news to one friend\n— Traduction française : Écrire des nouvelles privées à un ami", false], ["Avoid any organisation\n— Traduction française : Éviter toute organisation", false]]],
  ["**What should each main paragraph usually develop?**\n\n> **Traduction française :** Que doit généralement développer chaque paragraphe principal ?", "**Each main paragraph should develop one central idea.**\n\n> **Traduction française :** Chaque paragraphe principal doit développer une idée centrale.", [["One central idea\n— Traduction française : Une idée centrale", true], ["Every possible idea at once\n— Traduction française : Toutes les idées possibles à la fois", false], ["No complete sentence\n— Traduction française : Aucune phrase complète", false]]],
  ["**Which connector can show a consequence?**\n\n> **Traduction française :** Quel connecteur peut montrer une conséquence ?", "**“As a result” can introduce a consequence.**\n\n> **Traduction française :** « As a result » peut introduire une conséquence.", [["As a result\n— Traduction française : Par conséquent", true], ["Dear friend\n— Traduction française : Cher ami", false], ["Best wishes\n— Traduction française : Meilleurs vœux", false]]],
  ["**What should you do with a statistic or legal detail that is not verified?**\n\n> **Traduction française :** Que dois-tu faire avec une statistique ou un détail juridique non vérifié ?", "**Do not present it as fact; verify it first or use cautious wording.**\n\n> **Traduction française :** Ne le présente pas comme un fait ; vérifie-le d’abord ou utilise une formulation prudente.", [["Verify it or use cautious wording\n— Traduction française : Le vérifier ou employer une formulation prudente", true], ["Invent a source\n— Traduction française : Inventer une source", false], ["State it with certainty\n— Traduction française : L’affirmer avec certitude", false]]],
];
...
const migration = `-- Lot Anglais Terminale Unit 3 Development Issues : Reading et Writing bilingues.
...
begin
  ...
  loop
    ...
    update public.lessons set description='Unit 3 Development Issues : lecture critique du mariage des enfants et méthode approfondie de rédaction d’article bilingue.',content=${sqlText(lessonContent)},is_active=false where id=lesson_uuid;
    ...
    values (target.subject_id,target.level_id,target.series_id,chapter_uuid,lesson_uuid,'Exercise 1 — Reading: child marriage and evidence\n\n> **Traduction française :** Exercice 1 — Lecture : mariage des enfants et preuve',${sqlText("**Apply the strategies for general idea, vocabulary in context and evidence-based true-or-false answers.**\n\n> **Traduction française :** Applique les stratégies pour l’idée générale, le vocabulaire en contexte et les réponses vrai/faux fondées sur des preuves.")},${sqlText("**The correction uses only information visible in the supplied worksheet and explains the proof method.**\n\n> **Traduction française :** La correction utilise seulement les informations visibles dans la fiche fournie et explique la méthode de preuve.")},'single_choice','medium',${sqlText("**Choose the answer supported by the Unit 3 Reading prompt.**\n\n> **Traduction française :** Choisis la réponse appuyée par la consigne Reading de l’Unit 3.")},${sqlText("**Read the explanation in both languages before continuing.**\n\n> **Traduction française :** Lis l’explication dans les deux langues avant de continuer.")},false,false,25,10) returning id into exercise_reading_uuid;
${exerciseQuestionSql("exercise_reading_uuid", readingQuestions)}

    insert into public.exercises (subject_id,level_id,series_id,chapter_id,lesson_id,title,statement,solution,exercise_type,difficulty,content_markdown,correction_markdown,is_published,is_active,estimated_duration_minutes,display_order)
    values (target.subject_id,target.level_id,target.series_id,chapter_uuid,lesson_uuid,'Exercise 2 — Writing: build a responsible article\n\n> **Traduction française :** Exercice 2 — Écriture : construire un article responsable',${sqlText("**Choose the article structure, planning steps and ethical writing choices required by the Unit 3 task.**\n\n> **Traduction française :** Choisis la structure d’article, les étapes de planification et les choix d’écriture éthiques demandés par la tâche de l’Unit 3.")},${sqlText("**The correction strengthens title, introduction, main body, conclusion, one central idea per paragraph and evidence-aware language.**\n\n> **Traduction française :** La correction renforce le titre, l’introduction, le développement, la conclusion, une idée centrale par paragraphe et une langue attentive aux preuves.")},'single_choice','medium',${sqlText("**Plan first, then write 250–300 words with a title, introduction, developed paragraphs, conclusion and realistic solutions.**\n\n> **Traduction française :** Planifie d’abord, puis écris 250 à 300 mots avec un titre, une introduction, des paragraphes développés, une conclusion et des solutions réalistes.")},${sqlText("**A responsible article informs readers without inventing statistics or ignoring the people concerned.**\n\n> **Traduction française :** Un article responsable informe les lecteurs sans inventer de statistiques ni ignorer les personnes concernées.")},false,false,35,20) returning id into exercise_writing_uuid;
${exerciseQuestionSql("exercise_writing_uuid", writingQuestions)}

${quizSql("quiz_reading_uuid", "Bilingual quiz 1 — Reading: Development Issues\n\n> **Traduction française :** Quiz bilingue 1 — Lecture : problèmes de développement", "**Check prediction, general idea, contextual vocabulary and evidence in Unit 3 Reading.**\n\n> **Traduction française :** Vérifie l’anticipation, l’idée générale, le vocabulaire contextuel et la preuve dans la lecture de l’Unit 3.", readingQuiz, 10)}

${quizSql("quiz_writing_uuid", "Bilingual quiz 2 — Writing: a responsible article\n\n> **Traduction française :** Quiz bilingue 2 — Écriture : un article responsable", "**Check article structure, logical paragraphs, connectors and evidence-aware writing.**\n\n> **Traduction française :** Vérifie la structure de l’article, les paragraphes logiques, les connecteurs et une écriture attentive aux preuves.", writingQuiz, 20)}
  end loop;
end
...
writeFileSync(payloadPath, `${JSON.stringify({ project_id: "nnshioowwniursnozicg", name: "english_terminal_unit3_development_issues_bilingual_drafts", query: migration }, null, 2)}\n`, "utf8");
