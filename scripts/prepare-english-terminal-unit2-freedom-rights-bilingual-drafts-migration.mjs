...
const migrationPath = resolve(root, "supabase/migrations/20260823_english_terminal_unit2_freedom_rights_bilingual_drafts.sql");
const payloadPath = resolve(root, "supabase/migrations/20260823_english_terminal_unit2_freedom_rights_bilingual_drafts.apply.json");
...
const lessonContent = `## Unit 2 — Freedom and Civil Rights
...
Reformulated and expanded from the supplied PDFs: **Unit 2 Freedom and Rights — Listening for Comprehension**, **Reading for Comprehension** and **Writing an Informal Letter**, Far Ahead Terminale, Côte d’Ivoire — École numérique.`;

const listeningQuestions = [
  ["**What should you identify on a first listening?**\n\n> **Traduction française :** Que dois-tu identifier lors d’une première écoute ?", ["The speaker and the main topic\n— Traduction française : Le locuteur et le thème principal", "Every missing word immediately\n— Traduction française : Chaque mot manquant immédiatement", "Only the spelling of names\n— Traduction française : Seulement l’orthographe des noms"], ["The speaker and the main topic\n— Traduction française : Le locuteur et le thème principal"], "**The first listening is for global understanding: who speaks and what main difficulty or issue is discussed.**\n\n> **Traduction française :** La première écoute sert à la compréhension globale : qui parle et quelle difficulté ou quel problème principal est abordé."],
  ["**What can “financially” help you understand in a listening activity?**\n\n> **Traduction française :** Que peut t’aider à comprendre « financially » dans une activité d’écoute ?", ["Information about money or economic dependence\n— Traduction française : Une information sur l’argent ou la dépendance économique", "Information about the weather\n— Traduction française : Une information sur la météo", "Information about a birthday\n— Traduction française : Une information sur un anniversaire"], ["Information about money or economic dependence\n— Traduction française : Une information sur l’argent ou la dépendance économique"], "**The word “financially” introduces an economic aspect of a person’s situation.**\n\n> **Traduction française :** Le mot « financially » introduit un aspect économique de la situation d’une personne."],
  ["**True or false: respectful listening reduces a person to their disability.**\n\n> **Traduction française :** Vrai ou faux : une écoute respectueuse réduit une personne à son handicap.", ["False\n— Traduction française : Faux", "True\n— Traduction française : Vrai"], ["False\n— Traduction française : Faux"], "**Respectful language recognises the whole person, their choices, needs and rights.**\n\n> **Traduction française :** Un langage respectueux reconnaît la personne dans sa globalité, ses choix, ses besoins et ses droits."],
];

const readingQuestions = [
  ["**What is the safest way to state the general idea of the supplied reading activity?**\n\n> **Traduction française :** Quelle est la manière la plus sûre d’énoncer l’idée générale de l’activité de lecture fournie ?", ["It concerns a life story connected with slavery, freedom and education.\n— Traduction française : Elle concerne un récit de vie lié à l’esclavage, la liberté et l’éducation.", "It is a recipe for cocoa.\n— Traduction française : C’est une recette à base de cacao.", "It is an advertisement for a holiday.\n— Traduction française : C’est une publicité pour des vacances."], ["It concerns a life story connected with slavery, freedom and education.\n— Traduction française : Elle concerne un récit de vie lié à l’esclavage, la liberté et l’éducation."], "**This response uses only information visible in the worksheet and avoids inventing unseen details.**\n\n> **Traduction française :** Cette réponse utilise seulement les informations visibles dans la fiche et évite d’inventer des détails non visibles."],
  ["**Which explicit synonym does the worksheet provide?**\n\n> **Traduction française :** Quel synonyme explicite la fiche fournit-elle ?", ["remember → recall\n— Traduction française : remember → recall / se souvenir → se rappeler", "buyer → teacher\n— Traduction française : buyer → teacher / acheteur → enseignant", "education → accident\n— Traduction française : education → accident / éducation → accident"], ["remember → recall\n— Traduction française : remember → recall / se souvenir → se rappeler"], "**The worksheet itself gives “recall” as the example for “remember”.**\n\n> **Traduction française :** La fiche donne elle-même « recall » comme exemple pour « remember »."],
  ["**What must support a true-or-false answer in this reading task?**\n\n> **Traduction française :** Qu’est-ce qui doit soutenir une réponse vrai/faux dans cette tâche de lecture ?", ["A precise line or quotation from the text\n— Traduction française : Une ligne précise ou une citation du texte", "A guess based only on the title\n— Traduction française : Une supposition fondée seulement sur le titre", "An unrelated personal opinion\n— Traduction française : Une opinion personnelle sans rapport"], ["A precise line or quotation from the text\n— Traduction française : Une ligne précise ou une citation du texte"], "**The source asks learners to justify their answers by quoting the relevant lines.**\n\n> **Traduction française :** La source demande aux élèves de justifier leurs réponses en citant les lignes pertinentes."],
];

const writingQuestions = [
  ["**Which opening fits an informal letter to a friend?**\n\n> **Traduction française :** Quelle formule d’ouverture convient à une lettre informelle à un ami ?", ["Dear Akim,\n— Traduction française : Cher Akim,", "Dear Sir or Madam,\n— Traduction française : Madame, Monsieur,", "To whom it may concern,\n— Traduction française : À qui de droit,"], ["Dear Akim,\n— Traduction française : Cher Akim,"], "**A personal greeting such as “Dear Akim” matches a friendly informal letter.**\n\n> **Traduction française :** Une salutation personnelle comme « Dear Akim » convient à une lettre amicale informelle."],
  ["**What is the correct five-paragraph order from the source plan?**\n\n> **Traduction française :** Quel est l’ordre correct des cinq paragraphes selon le plan source ?", ["Friend → family/friends → yourself → feelings → positive closing news\n— Traduction française : Ami → famille/amis → soi-même → sentiments → nouvelles positives de clôture", "Feelings → signature → date → complaint → receiver\n— Traduction française : Sentiments → signature → date → plainte → destinataire", "Only one paragraph with all ideas mixed\n— Traduction française : Un seul paragraphe avec toutes les idées mélangées"], ["Friend → family/friends → yourself → feelings → positive closing news\n— Traduction française : Ami → famille/amis → soi-même → sentiments → nouvelles positives de clôture"], "**The worksheet gives this five-part plan to organise the reply to Akim.**\n\n> **Traduction française :** La fiche donne ce plan en cinq parties pour organiser la réponse à Akim."],
  ["**Which expression is warm and appropriate when replying to a friend after an accident?**\n\n> **Traduction française :** Quelle expression est chaleureuse et appropriée pour répondre à un ami après un accident ?", ["I was sorry to hear about the accident, and I hope you are receiving support.\n— Traduction française : J’ai été triste d’apprendre l’accident et j’espère que tu reçois du soutien.", "Your problem is not important.\n— Traduction française : Ton problème n’est pas important.", "I refuse to write to you again.\n— Traduction française : Je refuse de t’écrire encore."], ["I was sorry to hear about the accident, and I hope you are receiving support.\n— Traduction française : J’ai été triste d’apprendre l’accident et j’espère que tu reçois du soutien."], "**An informal letter can express empathy and encouragement without pity or invented facts.**\n\n> **Traduction française :** Une lettre informelle peut exprimer de l’empathie et des encouragements sans pitié ni faits inventés."],
  ["**What must be checked during peer review according to the source?**\n\n> **Traduction française :** Que faut-il vérifier pendant la relecture entre pairs selon la source ?", ["Informal language, spelling, grammar and punctuation\n— Traduction française : Langue informelle, orthographe, grammaire et ponctuation", "Only the colour of the paper\n— Traduction française : Seulement la couleur du papier", "Nothing, because informal letters need no correction\n— Traduction française : Rien, car les lettres informelles n’ont pas besoin de correction"], ["Informal language, spelling, grammar and punctuation\n— Traduction française : Langue informelle, orthographe, grammaire et ponctuation"], "**The PDF explicitly asks partners to check informal language, spelling, grammar and punctuation.**\n\n> **Traduction française :** Le PDF demande explicitement aux partenaires de vérifier la langue informelle, l’orthographe, la grammaire et la ponctuation."],
];

const quizListening = [
  ["**What should you listen for when a statement concerns how someone copes with a disability?**\n\n> **Traduction française :** Que dois-tu écouter lorsqu’une affirmation concerne la manière dont une personne fait face à un handicap ?", "**Listen for strategies, support, work, education, care or independence.**\n\n> **Traduction française :** Écoute les stratégies, le soutien, le travail, l’éducation, les soins ou l’autonomie.", [["Strategies and support\n— Traduction française : Des stratégies et du soutien", true], ["Only colours in the room\n— Traduction française : Seulement les couleurs dans la pièce", false], ["A recipe\n— Traduction française : Une recette", false]]],
  ["**What does “a major challenge” mean?**\n\n> **Traduction française :** Que signifie « a major challenge » ?", "**It means a serious difficulty that requires effort, preparation or support.**\n\n> **Traduction française :** Cela signifie une difficulté importante qui exige des efforts, une préparation ou un soutien.", [["A serious difficulty\n— Traduction française : Une difficulté importante", true], ["A small joke\n— Traduction française : Une petite blague", false], ["A guaranteed success\n— Traduction française : Une réussite garantie", false]]],
  ["**Which human-rights issue is proposed for the recording task?**\n\n> **Traduction française :** Quel problème de droits humains est proposé pour la tâche d’enregistrement ?", "**The source proposes gender discrimination in education, work opportunities for disabled people and justice for poor people.**\n\n> **Traduction française :** La source propose la discrimination de genre dans l’éducation, les possibilités d’emploi pour les personnes handicapées et la justice pour les personnes pauvres.", [["Job opportunities for disabled people\n— Traduction française : Les possibilités d’emploi pour les personnes handicapées", true], ["Choosing a holiday hotel\n— Traduction française : Choisir un hôtel de vacances", false], ["Buying a new phone\n— Traduction française : Acheter un nouveau téléphone", false]]],
  ["**True or false: respectful discussion must recognise both difficulties and rights.**\n\n> **Traduction française :** Vrai ou faux : une discussion respectueuse doit reconnaître à la fois les difficultés et les droits.", "**True. The lesson focuses on people’s situations, dignity, support and equal participation.**\n\n> **Traduction française :** Vrai. La leçon porte sur les situations des personnes, leur dignité, le soutien et la participation égale.", [["True\n— Traduction française : Vrai", true], ["False\n— Traduction française : Faux", false]]],
];

const quizReading = [
  ["**What does a general idea describe?**\n\n> **Traduction française :** Que décrit l’idée générale ?", "**It describes the central message, not every detail in the text.**\n\n> **Traduction française :** Elle décrit le message central et non chaque détail du texte.", [["The central message\n— Traduction française : Le message central", true], ["Every punctuation mark\n— Traduction française : Chaque signe de ponctuation", false], ["Only the final line\n— Traduction française : Seulement la dernière ligne", false]]],
  ["**Which strategy helps find a synonym in context?**\n\n> **Traduction française :** Quelle stratégie aide à trouver un synonyme dans le contexte ?", "**Read the full sentence, identify the word class and compare the meaning in context.**\n\n> **Traduction française :** Lis la phrase entière, identifie la nature du mot et compare le sens dans le contexte.", [["Read the full sentence and context\n— Traduction française : Lire la phrase entière et le contexte", true], ["Guess without reading\n— Traduction française : Deviner sans lire", false], ["Ignore the paragraph\n— Traduction française : Ignorer le paragraphe", false]]],
  ["**Which statement is explicitly marked true in the worksheet example?**\n\n> **Traduction française :** Quelle affirmation est explicitement marquée vraie dans l’exemple de la fiche ?", "**The example says that the narrator does not know when he was born, true at line 2.**\n\n> **Traduction française :** L’exemple indique que le narrateur ne sait pas quand il est né, vrai à la ligne 2.", [["The narrator does not know when he was born.\n— Traduction française : Le narrateur ne sait pas quand il est né.", true], ["The narrator wrote the story as a child.\n— Traduction française : Le narrateur a écrit l’histoire enfant.", false], ["The narrator never needed evidence.\n— Traduction française : Le narrateur n’a jamais eu besoin de preuve.", false]]],
  ["**What should a report on child labour request?**\n\n> **Traduction française :** Que doit demander un signalement sur le travail des enfants ?", "**It should request investigation and protective action, while describing observed facts carefully.**\n\n> **Traduction française :** Il doit demander une enquête et une action de protection, tout en décrivant soigneusement les faits observés.", [["Protective action\n— Traduction française : Une action de protection", true], ["More dangerous work\n— Traduction française : Davantage de travail dangereux", false], ["No access to school\n— Traduction française : Aucun accès à l’école", false]]],
];

const quizWriting = [
  ["**Why is “Dear Akim,” appropriate in this task?**\n\n> **Traduction française :** Pourquoi « Dear Akim, » est-il approprié dans cette tâche ?", "**Akim is a friend and former classmate, so a personal informal greeting fits.**\n\n> **Traduction française :** Akim est un ami et ancien camarade, donc une salutation personnelle informelle convient.", [["It is a personal greeting for a friend.\n— Traduction française : C’est une salutation personnelle pour un ami.", true], ["It is a complaint to a ministry.\n— Traduction française : C’est une plainte à un ministère.", false], ["It is an official legal formula.\n— Traduction française : C’est une formule juridique officielle.", false]]],
  ["**What is the first paragraph expected to do?**\n\n> **Traduction française :** Que doit faire le premier paragraphe ?", "**The source plan says to ask about your friend.**\n\n> **Traduction française :** Le plan source demande de prendre des nouvelles de l’ami.", [["Ask about your friend\n— Traduction française : Prendre des nouvelles de ton ami", true], ["List grammar mistakes\n— Traduction française : Lister les fautes de grammaire", false], ["Report a company\n— Traduction française : Signaler une entreprise", false]]],
  ["**Which connector can introduce personal news?**\n\n> **Traduction française :** Quel connecteur peut introduire des nouvelles personnelles ?", "**“As for me” helps shift naturally to your own news.**\n\n> **Traduction française :** « As for me » aide à passer naturellement à tes propres nouvelles.", [["As for me\n— Traduction française : Quant à moi", true], ["Yours faithfully\n— Traduction française : Veuillez agréer", false], ["No evidence\n— Traduction française : Aucune preuve", false]]],
  ["**What makes an informal letter successful?**\n\n> **Traduction française :** Qu’est-ce qui rend une lettre informelle réussie ?", "**It is personal, organised and accurate, with friendly language and careful checking.**\n\n> **Traduction française :** Elle est personnelle, organisée et correcte, avec une langue amicale et une relecture attentive.", [["Friendly language, clear organisation and accurate writing\n— Traduction française : Langue amicale, organisation claire et écriture correcte", true], ["One long unplanned paragraph\n— Traduction française : Un long paragraphe non planifié", false], ["Insults and no punctuation\n— Traduction française : Des insultes et aucune ponctuation", false]]],
];

function exerciseQuestionSql(variable, questions) {
  return `insert into public.exercise_questions (exercise_id,question_type,prompt_markdown,options,correct_answers,explanation_markdown,display_order) values\n${questions.map(([prompt, options, correct, explanation], index) => `      (${variable},${sqlText(options.length === 2 ? "true_false" : "single_choice")},${sqlText(prompt)},${jsonbArray(options)},${jsonbArray(correct)},${sqlText(explanation)},${(index + 1) * 10})`).join(",\n")};`;
}

function quizSql(variable, title, description, rows, order) {
...
const migration = `-- Lot Anglais Terminale Unit 2 Freedom and Rights : Listening, Reading et Writing bilingues.
...
begin
  ...
  if exists (
    ...
    where ch.subject_offering_id in (${offerings.map(sqlText).join(", ")}) and le.title=unit_title
  ...
  for target in
    ...
    where o.id in (${offerings.map(sqlText).join(", ")}) order by se.name
  loop
    ...
    if lesson_uuid is null then
      ...
      values (chapter_uuid,unit_title,'Unit 2 Freedom and Civil Rights : compréhension orale, lecture responsable des droits humains et méthode très guidée de lettre informelle bilingue.',${sqlText(lessonContent)},lesson_order,false) returning id into lesson_uuid;
    else
      ...
      update public.lessons set description='Unit 2 Freedom and Civil Rights : compréhension orale, lecture responsable des droits humains et méthode très guidée de lettre informelle bilingue.',content=${sqlText(lessonContent)},is_active=false where id=lesson_uuid;
    end if;
    ...
    values (target.subject_id,target.level_id,target.series_id,chapter_uuid,lesson_uuid,'Exercise 1 — Listening: Human Rights and disability inclusion\n\n> **Traduction française :** Exercice 1 — Écoute : droits humains et inclusion des personnes handicapées',${sqlText("**Apply the listening strategy to identify themes, language clues and respectful ways to speak about rights.**\n\n> **Traduction française :** Applique la stratégie d’écoute pour identifier les thèmes, les indices linguistiques et les manières respectueuses de parler des droits.")},${sqlText("**The correction distinguishes topic, grammar clues and respectful human-rights language.**\n\n> **Traduction française :** La correction distingue le thème, les indices grammaticaux et une langue respectueuse des droits humains.")},'single_choice','easy',${sqlText("**Read each prompt, predict the information type, then choose the answer that fits the context.**\n\n> **Traduction française :** Lis chaque consigne, anticipe le type d’information, puis choisis la réponse qui convient au contexte.")},${sqlText("**Check the bilingual explanation after each answer.**\n\n> **Traduction française :** Vérifie l’explication bilingue après chaque réponse.")},false,false,20,10) returning id into exercise_listening_uuid;
${exerciseQuestionSql("exercise_listening_uuid", listeningQuestions)}

    insert into public.exercises (subject_id,level_id,series_id,chapter_id,lesson_id,title,statement,solution,exercise_type,difficulty,content_markdown,correction_markdown,is_published,is_active,estimated_duration_minutes,display_order)
    values (target.subject_id,target.level_id,target.series_id,chapter_uuid,lesson_uuid,'Exercise 2 — Reading: freedom, evidence and children’s rights\n\n> **Traduction française :** Exercice 2 — Lecture : liberté, preuve et droits de l’enfant',${sqlText("**Use the reading strategies for general idea, contextual vocabulary and evidence-based true/false answers.**\n\n> **Traduction française :** Utilise les stratégies de lecture pour l’idée générale, le vocabulaire contextuel et les réponses vrai/faux fondées sur des preuves.")},${sqlText("**The correction uses only the information visible in the worksheet and explains how to cite evidence.**\n\n> **Traduction française :** La correction utilise seulement les informations visibles dans la fiche et explique comment citer une preuve.")},'single_choice','medium',${sqlText("**Do not invent unseen details: identify the method that the source supports.**\n\n> **Traduction française :** N’invente pas de détails non visibles : identifie la méthode appuyée par la source.")},${sqlText("**A sound answer identifies the main idea or cites a precise line.**\n\n> **Traduction française :** Une bonne réponse identifie l’idée générale ou cite une ligne précise.")},false,false,20,20) returning id into exercise_reading_uuid;
${exerciseQuestionSql("exercise_reading_uuid", readingQuestions)}

    insert into public.exercises (subject_id,level_id,series_id,chapter_id,lesson_id,title,statement,solution,exercise_type,difficulty,content_markdown,correction_markdown,is_published,is_active,estimated_duration_minutes,display_order)
    values (target.subject_id,target.level_id,target.series_id,chapter_uuid,lesson_uuid,'Exercise 3 — Writing: organise an informal reply to a friend\n\n> **Traduction française :** Exercice 3 — Écriture : organiser une réponse informelle à un ami',${sqlText("**Choose the correct informal tone, the five-paragraph plan and the peer-review criteria for a reply to Akim.**\n\n> **Traduction française :** Choisis le ton informel correct, le plan en cinq paragraphes et les critères de relecture pour une réponse à Akim.")},${sqlText("**The correction explains each step of the informal-letter method and the difference from formal writing.**\n\n> **Traduction française :** La correction explique chaque étape de la méthode de lettre informelle et la différence avec l’écriture formelle.")},'single_choice','medium',${sqlText("**Plan before writing: friend, family/friends, yourself, feelings and a positive closing.**\n\n> **Traduction française :** Planifie avant d’écrire : ami, famille/amis, soi-même, sentiments et clôture positive.")},${sqlText("**A friendly tone must still be organised, accurate and respectful.**\n\n> **Traduction française :** Un ton amical doit rester organisé, correct et respectueux.")},false,false,30,30) returning id into exercise_writing_uuid;
${exerciseQuestionSql("exercise_writing_uuid", writingQuestions)}

${quizSql("quiz_listening_uuid", "Bilingual quiz 1 — Listening: Human Rights\n\n> **Traduction française :** Quiz bilingue 1 — Écoute : droits humains", "**Check listening strategies and respectful language for Human Rights topics.**\n\n> **Traduction française :** Vérifie les stratégies d’écoute et la langue respectueuse pour les thèmes des droits humains.", quizListening, 10)}

${quizSql("quiz_reading_uuid", "Bilingual quiz 2 — Reading: Freedom and Rights\n\n> **Traduction française :** Quiz bilingue 2 — Lecture : liberté et droits", "**Check general idea, contextual vocabulary, evidence and children’s rights.**\n\n> **Traduction française :** Vérifie l’idée générale, le vocabulaire contextuel, la preuve et les droits de l’enfant.", quizReading, 20)}

${quizSql("quiz_writing_uuid", "Bilingual quiz 3 — Writing: an informal letter\n\n> **Traduction française :** Quiz bilingue 3 — Écriture : une lettre informelle", "**Check the personal tone, five-paragraph plan and peer-review method of an informal letter.**\n\n> **Traduction française :** Vérifie le ton personnel, le plan en cinq paragraphes et la méthode de relecture d’une lettre informelle.", quizWriting, 30)}
  end loop;
end
...
writeFileSync(payloadPath, `${JSON.stringify({ project_id: "nnshioowwniursnozicg", name: "english_terminal_unit2_freedom_rights_bilingual_drafts", query: migration }, null, 2)}\n`, "utf8");
