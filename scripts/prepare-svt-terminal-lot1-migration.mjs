...
const array = (values) => `jsonb_build_array(${values.map(quote).join(", ")})`;

const lessons = {
  reactions: {
    title: "Leçon 1 : Les réactions émotionnelles chez l’Homme.",
    chapter: "Thème : La communication dans l’organisme.",
    description:
      "Manifestations, causes et régulation nerveuse, hormonale et neuro-hormonale des réactions émotionnelles.",
    course: `## Les réactions émotionnelles chez l’Homme
...
Contenu reformulé et approfondi à partir du PDF fourni : **« Les réactions émotionnelles chez l’Homme »**, SVT, Terminale A, Côte d’Ivoire – École numérique.`,
    exerciseA: {
      title: "Exercice 1 — Manifestations et causes des réactions émotionnelles",
      difficulty: "easy",
      duration: 15,
      questions: [
        ["single_choice", "Quelle proposition correspond à une manifestation invisible d’une réaction émotionnelle ?", ["L’augmentation du taux d’adrénaline dans le sang", "Les pleurs", "La pâleur du visage", "Les frissons"], ["L’augmentation du taux d’adrénaline dans le sang"], "Le dosage hormonal met en évidence une manifestation invisible, contrairement aux pleurs ou à la pâleur.", 10],
        ["single_choice", "L’attente d’un résultat scolaire appartient à quelle catégorie de cause ?", ["Une contrainte d’ordre émotionnel", "Une agression physique", "Une modification de l’environnement", "Une réponse hormonale"], ["Une contrainte d’ordre émotionnel"], "Le support classe l’attente d’un résultat parmi les contraintes émotionnelles pouvant déclencher le stress.", 20],
        ["true_false", "La déshydratation est citée comme une modification brutale de l’environnement susceptible de provoquer du stress.", ["Vrai", "Faux"], ["Vrai"], "La déshydratation est classée dans les modifications de l’environnement dans le document.", 30],
      ],
    },
    exerciseB: {
      title: "Exercice 2 — Régulation nerveuse et hormonale du stress",
      difficulty: "medium",
      duration: 20,
      questions: [
        ["single_choice", "Quel enchaînement hormonal respecte le schéma du cours ?", ["Hypothalamus → CRH → hypophyse → ACTH → corticosurrénale", "Hypophyse → CRH → hypothalamus → ACTH", "Corticosurrénale → CRH → hypothalamus", "Système limbique → ACTH → CRH"], ["Hypothalamus → CRH → hypophyse → ACTH → corticosurrénale"], "Le cours présente la CRH comme hormone hypothalamique et l’ACTH comme hormone hypophysaire stimulant la corticosurrénale.", 10],
        ["single_choice", "Quelle hormone est associée à la phase d’alarme dans le support ?", ["L’adrénaline", "Le cortisol uniquement", "La CRH uniquement", "L’ACTH uniquement"], ["L’adrénaline"], "L’adrénaline, une catécholamine, prépare l’organisme à la lutte ou à la fuite lors de la phase d’alarme.", 20],
        ["true_false", "La régulation nerveuse et la régulation hormonale agissent sans aucun lien entre elles.", ["Vrai", "Faux"], ["Faux"], "Le document conclut à une intégration neuro-hormonale grâce au rôle du système limbique et de l’hypothalamus.", 30],
      ],
    },
    quiz: {
      title: "Quiz de révision — Les réactions émotionnelles",
      questions: [
        ["Le système limbique intervient principalement dans…", "Il participe au déclenchement des émotions et à la valeur affective des stimulations.", ["les émotions", "la digestion uniquement"], 10],
        ["Quelle glande libère les catécholamines selon le support ?", "Le cours mentionne la médullosurrénale.", ["La médullosurrénale", "La corticosurrénale"], 20],
        ["Quel effet de l’adrénaline est cité ?", "L’adrénaline augmente notamment la fréquence et la force des contractions cardiaques.", ["L’augmentation de l’activité cardiaque", "La suppression de toute respiration"], 30],
        ["Le rétrocontrôle des glucocorticoïdes agit sur…", "Le support indique une action en retour sur le complexe hypothalamo-hypophysaire.", ["le complexe hypothalamo-hypophysaire", "les os uniquement"], 40],
      ],
    },
  },
  cerebral: {
    title: "Leçon 2 : L’activité cérébrale chez l’Homme.",
    chapter: "Thème : La communication dans l’organisme.",
    description:
      "Aires cérébrales, motricité volontaire, mémoire et trajet de l’influx nerveux chez l’Homme.",
    course: `## L’activité cérébrale chez l’Homme
...
Contenu reformulé et approfondi à partir du PDF fourni : **« L’activité cérébrale chez l’Homme »**, SVT, Terminale A, Côte d’Ivoire – École numérique.`,
    exerciseA: {
      title: "Exercice 1 — Aires cérébrales et fonctions",
      difficulty: "easy",
      duration: 15,
      questions: [
        ["single_choice", "Dans quel lobe se situe l’aire motrice selon le cours ?", ["Le lobe frontal", "Le lobe occipital", "Le lobe temporal", "Le lobe pariétal uniquement"], ["Le lobe frontal"], "Le document situe l’aire motrice dans le lobe frontal, en avant du sillon de Rolando.", 10],
        ["single_choice", "Quelle aire est reliée à la vision et à la reconnaissance d’objets ?", ["L’aire visuelle et psycho-visuelle", "L’aire auditive", "L’aire motrice", "L’aire gustative uniquement"], ["L’aire visuelle et psycho-visuelle"], "Les aires visuelle et psycho-visuelle, localisées dans le lobe occipital, sont en relation avec l’œil.", 20],
        ["true_false", "La mémoire fait partie des manifestations de l’activité cérébrale citées dans le support.", ["Vrai", "Faux"], ["Vrai"], "Le PDF cite expressément la mémoire parmi les manifestations de l’activité cérébrale.", 30],
      ],
    },
    exerciseB: {
      title: "Exercice 2 — Motricité volontaire et mémoire",
      difficulty: "medium",
      duration: 20,
      questions: [
        ["single_choice", "Quelle est la première phase du mécanisme de la motricité volontaire ?", ["La phase préparatoire", "La phase d’exécution", "La restitution", "La consolidation"], ["La phase préparatoire"], "La phase préparatoire précède la programmation et l’exécution ; elle utilise notamment les informations sensorielles.", 10],
        ["single_choice", "Quel élément fait partie des paramètres programmés avant un geste ?", ["La direction du mouvement", "La couleur du cortex", "La disparition de la moelle épinière", "La suppression de tout message nerveux"], ["La direction du mouvement"], "Le cours cite la latéralisation, la direction, la distance et la force parmi les paramètres programmés.", 20],
        ["true_false", "La restitution est une phase du mécanisme mnésique.", ["Vrai", "Faux"], ["Vrai"], "Le support présente l’acquisition, la consolidation/stockage et la restitution du souvenir.", 30],
      ],
    },
    quiz: {
      title: "Quiz de révision — L’activité cérébrale",
      questions: [
        ["Quelle aire participe à la commande des mouvements intentionnels ?", "Il s’agit de l’aire motrice.", ["L’aire motrice", "L’aire olfactive uniquement"], 10],
        ["Quelle phase fixe notamment le bras à utiliser et la force du geste ?", "C’est la phase de programmation.", ["La programmation", "La restitution"], 20],
        ["Quel organe est cité comme impliqué dans la mémoire ?", "Le support mentionne notamment l’hippocampe.", ["L’hippocampe", "La médullosurrénale"], 30],
        ["L’amnésie désigne…", "Le cours la définit comme une diminution ou une perte de mémoire.", ["une diminution ou une perte de mémoire", "une amélioration automatique de la mémoire"], 40],
      ],
    },
  },
  origin: {
    title: "Leçon 1 : L’origine de la vie.",
    chapter: "Thème 1 : L’origine de la vie et l’évolution de la lignée humaine.",
    description:
      "Faits paléontologiques et expérimentaux mobilisés dans l’explication scientifique de l’origine de la vie.",
    course: `## L’origine de la vie
...
Contenu reformulé et approfondi à partir du PDF fourni : **« L’origine de la vie »**, SVT, Terminale A, Côte d’Ivoire – École numérique.`,
    exerciseA: {
      title: "Exercice 1 — Faits paléontologiques et évolution de l’atmosphère",
      difficulty: "easy",
      duration: 15,
      questions: [
        ["single_choice", "Quel indice est associé à une faible teneur ancienne en dioxygène dans le support ?", ["La pechblende dans des sables anciens", "Le fonctionnement du cœur", "Les muscles striés", "Les aires visuelles"], ["La pechblende dans des sables anciens"], "Le document associe l’abondance de pechblende à une faible teneur en dioxygène au moment du dépôt.", 10],
        ["single_choice", "Quel phénomène est relié à l’enrichissement de l’atmosphère en dioxygène ?", ["La photosynthèse des algues", "La disparition des molécules organiques", "La suppression des rayonnements solaires", "La motricité volontaire"], ["La photosynthèse des algues"], "Le support relie l’activité photosynthétique des algues à l’apparition et à l’accumulation de dioxygène.", 20],
        ["true_false", "Les couches rouges sont utilisées dans le document comme indice d’une présence plus constante de dioxygène.", ["Vrai", "Faux"], ["Vrai"], "Le texte présente les couches rouges riches en oxydes de fer comme témoignant d’une présence plus constante de dioxygène.", 30],
      ],
    },
    exerciseB: {
      title: "Exercice 2 — Expériences et limites de l’explication scientifique",
      difficulty: "medium",
      duration: 20,
      questions: [
        ["single_choice", "Quel résultat est attribué à l’expérience de Miller et Urey dans le support ?", ["L’obtention d’acides aminés", "La création démontrée d’une cellule vivante", "La suppression du dioxygène actuel", "La localisation des aires cérébrales"], ["L’obtention d’acides aminés"], "Le document rapporte l’obtention d’acides aminés, notamment glycine et alanine, à partir des conditions expérimentales décrites.", 10],
        ["single_choice", "Quelle limite scientifique est explicitement formulée ?", ["Le passage des molécules organiques aux premières cellules reste inconnu", "Les molécules organiques n’existent jamais", "La photosynthèse ne libère aucun dioxygène", "Les fossiles expliquent tout sans incertitude"], ["Le passage des molécules organiques aux premières cellules reste inconnu"], "Le cours insiste sur l’absence de démonstration complète du passage de l’inanimé au vivant.", 20],
        ["true_false", "La synthèse de molécules organiques suffit à prouver toutes les propriétés fondamentales du vivant.", ["Vrai", "Faux"], ["Faux"], "Le document précise que les produits obtenus ne manifestent pas à eux seuls l’autorégulation et la reproduction.", 30],
      ],
    },
    quiz: {
      title: "Quiz de révision — L’origine de la vie",
      questions: [
        ["Que sont les fers rubanés dans le raisonnement du cours ?", "Ce sont des formations sédimentaires utilisées comme indices sur l’atmosphère ancienne.", ["des indices géologiques", "des aires cérébrales"], 10],
        ["Quel gaz s’accumule progressivement dans l’atmosphère selon le support ?", "Le dioxygène s’enrichit progressivement avec l’activité photosynthétique évoquée.", ["Le dioxygène", "L’ACTH"], 20],
        ["Quelle molécule est citée comme obtenue dans les expériences de Miller et Urey ?", "Le cours cite notamment la glycine et l’alanine.", ["La glycine", "L’adrénaline"], 30],
        ["Quelle propriété fondamentale manque aux produits expérimentaux cités ?", "Le document indique qu’ils ne manifestent pas toutes les propriétés, dont l’autorégulation et la reproduction.", ["L’autorégulation et la reproduction", "La couleur rouge"], 40],
      ],
    },
  },
};
  ...
  return questions
    .map(
      ([type, prompt, options, correct, explanation, order]) =>
        `        (${variable},${quote(type)},${quote(prompt)},${array(options)},${array(correct)},${quote(explanation)},${order})`,
    )
    .join(",\n");
}

function renderQuiz(targetKey, quiz) {
  const questionRows = quiz.questions
    .map(
      ([question, explanation, _answers, order]) =>
        `          (quiz_uuid,${quote(question)},${quote(explanation)},'single_choice',${order},1,true)`,
    )
    .join(",\n");
  const answerRows = quiz.questions
    .flatMap(([_question, _explanation, answers, order]) => [
      `          (${order},${quote(answers[0])},true,10)`,
      `          (${order},${quote(answers[1])},false,20)`,
    ])
    .join(",\n");

  return `      with inserted_questions as (
...
function renderCase(key, lesson, index) {
  return `    ${index === 0 ? "if" : "elsif"} target.lesson_key=${quote(key)} then
...
$${key}$;
      ...
      quiz_title := ${quote(lesson.quiz.title)};`;
}

const cases = Object.entries(lessons)
  .map(([key, lesson], index) => renderCase(key, lesson, index))
  .join("\n") + `
    else
      raise exception 'Leçon SVT cible non reconnue : %', target.lesson_id;
    end if;`;

const exerciseBranches = Object.entries(lessons)
  .map(
    ([key, lesson], index) =>
      `${index === 0 ? "      if" : "      elsif"} target.lesson_key=${quote(key)} then
...
const exerciseBBranches = Object.entries(lessons)
  .map(
    ([key, lesson], index) =>
      `${index === 0 ? "      if" : "      elsif"} target.lesson_key=${quote(key)} then
        insert into public.exercise_questions (exercise_id,question_type,prompt_markdown,options,correct_answers,explanation_markdown,display_order) values
...
const quizBranches = Object.entries(lessons)
  .map(
    ([key, lesson], index) =>
      `${index === 0 ? "      if" : "      elsif"} target.lesson_key=${quote(key)} then
${renderQuiz(key, lesson.quiz)}
      `,
  )
  .join("");

const sql = `-- Brouillons SVT Terminale A1/A2 : réactions émotionnelles, activité cérébrale et origine de la vie.
