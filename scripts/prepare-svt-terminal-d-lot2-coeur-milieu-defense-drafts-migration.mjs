...
const applyInputPath = resolve(
  "supabase/migrations/20260822_svt_terminale_d_coeur_milieu_interieur_defense_drafts.apply.json",
);
...
const lessons = [
  {
    id: "bc4eeecc-6dd3-457a-8ee2-51e191892891",
    description:
      "Automatisme cardiaque, cycle cardiaque, contrôle nerveux et médiateurs chimiques de l’activité du cœur.",
    content: String.raw`## Le fonctionnement du cœur
...
Contenu reformulé, structuré et approfondi à partir du PDF fourni : **« Le fonctionnement du cœur »**, SVT, Terminale D, Côte d’Ivoire — École numérique.`,
    exerciseA: {
      title: "Exercice 1 — Tissu nodal et cycle cardiaque",
      difficulty: "easy",
      duration: 20,
      statement:
        "Identifiez le siège de l’automatisme cardiaque et reliez les ondes de l’ECG aux phases du cycle cardiaque.",
      solution:
        "La correction distingue le nœud sinusal, le tissu nodal, la systole auriculaire, la systole ventriculaire et la diastole générale.",
      questions: [
        ["single_choice", "Quelle structure est appelée pacemaker du cœur dans le document ?", ["Le nœud sinusal", "Le faisceau de His", "Le ventricule gauche", "Le nerf de Cyon"], ["Le nœud sinusal"], "Le nœud sinusal impose son rythme au myocarde ; le support le présente comme le pacemaker du cœur.", 10],
        ["single_choice", "À quel phénomène correspond le complexe QRS de l’ECG ?", ["La dépolarisation des ventricules", "La repolarisation des oreillettes", "La diastole auriculaire", "La digestion des médiateurs"], ["La dépolarisation des ventricules"], "Le complexe QRS précède la systole ventriculaire car il correspond à la dépolarisation des ventricules.", 20],
        ["true_false", "La destruction du tissu nodal d’un cœur isolé provoque l’arrêt de ses battements.", ["Vrai", "Faux"], ["Vrai"], "Le PDF utilise cette expérience pour montrer que le tissu nodal est le siège de l’automatisme cardiaque.", 30],
      ],
    },
    exerciseB: {
      title: "Exercice 2 — Contrôles nerveux et chimiques",
      difficulty: "medium",
      duration: 25,
      statement:
        "Interprétez les effets antagonistes des nerfs cardiaques et expliquez l’expérience de Loewi avec les médiateurs chimiques cités.",
      solution:
        "La correction oppose les influences parasympathiques et orthosympathiques puis relie l’acétylcholine au ralentissement et l’adrénaline à l’accélération.",
      questions: [
        ["single_choice", "Quel effet provoque la stimulation des nerfs parasympathiques sur le rythme cardiaque ?", ["Un ralentissement du rythme", "Une accélération durable", "L’arrêt définitif de l’automatisme", "Aucun effet"], ["Un ralentissement du rythme"], "Les fibres parasympathiques transmettent des influx modérateurs qui diminuent le rythme cardiaque.", 10],
        ["single_choice", "Quelle substance est cardiomodératrice selon le support ?", ["L’acétylcholine", "L’adrénaline", "La rénine", "Le sodium"], ["L’acétylcholine"], "La perfusion d’acétylcholine ralentit l’activité du nœud sinusal ; elle est donc cardiomodératrice.", 20],
        ["true_false", "Les nerfs de Héring et de Cyon sont décrits comme des nerfs sensitifs.", ["Vrai", "Faux"], ["Vrai"], "Ils transmettent l’information des barorécepteurs vers les centres nerveux cardio-vasculaires.", 30],
      ],
    },
    quiz: {
      title: "Quiz de révision — Fonctionnement du cœur",
      questions: [
        ["Quel tissu particulier est le siège de l’automatisme cardiaque ?", "Le tissu nodal est présenté comme le siège de l’automatisme du cœur.", ["Le tissu nodal", "Le tissu osseux"], 10],
        ["Quelle phase correspond au relâchement général du muscle cardiaque ?", "Le cardiogramme associe la diastole générale au relâchement général du muscle cardiaque.", ["La diastole générale", "La systole ventriculaire"], 20],
        ["Quel système nerveux accélère le rythme cardiaque dans le document ?", "Les nerfs orthosympathiques transmettent des influx accélérateurs.", ["Le système orthosympathique", "Le système parasympathique"], 30],
        ["Quel médiateur stimule l’activité du nœud sinusal ?", "L’adrénaline ou noradrénaline est cardioaccélératrice dans le support.", ["L’adrénaline", "L’acétylcholine"], 40],
      ],
    },
  },
  {
    id: "917453a3-abdc-4991-8db5-94a37d4ba2de",
    description:
      "Structure et fonctions du rein, formation de l’urine, régulations de l’eau, du sodium et du pH dans le maintien du milieu intérieur.",
    content: String.raw`## Le maintien de la constance du milieu intérieur
...
Contenu reformulé, structuré et approfondi à partir du PDF fourni : **« Le maintien de la constance du milieu intérieur »**, SVT, Terminale D, Côte d’Ivoire — Mon École à la Maison.`,
    exerciseA: {
      title: "Exercice 1 — Néphron et formation de l’urine",
      difficulty: "easy",
      duration: 20,
      statement:
        "Identifiez les constituants du néphron puis associez filtration, réabsorption, sécrétion et excrétion aux mécanismes de formation de l’urine.",
      solution:
        "La correction distingue le corpuscule de Malpighi, les tubes urinaires, le filtrat glomérulaire et les quatre fonctions du néphron.",
      questions: [
        ["single_choice", "Quelle structure est l’unité fonctionnelle du rein ?", ["Le néphron", "Le neurone", "Le sarcomère", "Le ganglion"], ["Le néphron"], "Le document définit le néphron comme l’unité structurale et fonctionnelle du rein.", 10],
        ["single_choice", "Où se déroule la filtration glomérulaire selon le support ?", ["Au niveau du glomérule", "Dans le bassinet", "Dans l’uretère", "Dans la corticosurrénale"], ["Au niveau du glomérule"], "La filtration du plasma par le rein se fait au niveau du glomérule du néphron.", 20],
        ["true_false", "L’urine primitive est le filtrat obtenu à la suite de la filtration glomérulaire.", ["Vrai", "Faux"], ["Vrai"], "Le PDF nomme filtrat glomérulaire ou urine primitive le produit de la filtration au glomérule.", 30],
      ],
    },
    exerciseB: {
      title: "Exercice 2 — Régulations de l’eau et du sodium",
      difficulty: "medium",
      duration: 25,
      statement:
        "Interprétez les chaînes de régulation de l’eau et du sodium en utilisant la volémie, la pression osmotique, l’ADH et l’aldostérone.",
      solution:
        "La correction relie une baisse d’ADH à une augmentation de diurèse et une faible aldostérone à une faible réabsorption de sodium.",
      questions: [
        ["single_choice", "Après une ingestion importante d’eau, quel effet du document est attendu sur l’ADH ?", ["Sa sécrétion diminue", "Sa sécrétion augmente toujours", "Elle est remplacée par l’adrénaline", "Elle ne joue aucun rôle"], ["Sa sécrétion diminue"], "La dilution du plasma et la baisse de pression osmotique diminuent la sécrétion d’ADH selon le PDF.", 10],
        ["single_choice", "Quelle hormone stimule la réabsorption de sodium dans les tubules rénaux ?", ["L’aldostérone", "L’acétylcholine", "La perforine", "Le lysozyme"], ["L’aldostérone"], "Le support attribue à l’aldostérone, produite par la corticosurrénale, la stimulation de la réabsorption du sodium.", 20],
        ["true_false", "La polyurie correspond à une élimination abondante d’une urine moins concentrée.", ["Vrai", "Faux"], ["Vrai"], "Le document emploie polyurie lorsque la diurèse augmente et que l’urine éliminée est moins concentrée.", 30],
      ],
    },
    quiz: {
      title: "Quiz de révision — Milieu intérieur et rein",
      questions: [
        ["Comment appelle-t-on l’ensemble des régulations qui maintiennent un équilibre dynamique du milieu intérieur ?", "Le document définit l’homéostasie comme l’ensemble des régulations du milieu intérieur.", ["L’homéostasie", "La phagocytose"], 10],
        ["Quelle hormone agit sur la réabsorption de l’eau dans les tubules rénaux ?", "L’ADH est l’hormone antidiurétique indiquée pour la régulation de l’eau.", ["L’ADH", "L’aldostérone uniquement"], 20],
        ["Quel effet entraîne une forte réabsorption d’eau dans le mécanisme présenté ?", "Une forte réabsorption d’eau réduit la diurèse et favorise une urine concentrée.", ["Une diminution de la diurèse", "Une augmentation obligatoire de la diurèse"], 30],
        ["Quel pH est cité dans le document comme valeur normale dans la régulation acido-basique ?", "Le support utilise 7,4 comme valeur de référence pour le pH plasmatique.", ["7,4", "3,5"], 40],
      ],
    },
  },
  {
    id: "45fd2641-0833-4279-819c-6ef572b6b40e",
    description:
      "Barrières et réponse inflammatoire, défense spécifique, soi/non-soi, réponses immunitaires humorale et cellulaire.",
    content: String.raw`## Le système de défense de l’organisme
...
Contenu reformulé, structuré et approfondi à partir du PDF fourni : **« Le système de défense de l’organisme »**, SVT, Terminale D, Côte d’Ivoire — Mon École à la Maison.`,
    exerciseA: {
      title: "Exercice 1 — Défense non spécifique et phagocytose",
      difficulty: "easy",
      duration: 20,
      statement:
        "Distinguez les barrières naturelles, les signes de la réaction inflammatoire et les étapes de la phagocytose.",
      solution:
        "La correction relie les barrières aux exemples du cours et ordonne adhésion, absorption puis digestion par les enzymes lytiques.",
      questions: [
        ["single_choice", "Quel phénomène correspond à la reconnaissance, l’engloutissement puis la digestion de microbes par un phagocyte ?", ["La phagocytose", "La systole", "La réabsorption", "La cytolyse"], ["La phagocytose"], "Le document définit la phagocytose comme la capacité de reconnaître, englober puis digérer des microbes.", 10],
        ["single_choice", "Quelle cellule provient de la différenciation des monocytes selon le support ?", ["Le macrophage", "Le plasmocyte", "L’hématie", "Le neurone"], ["Le macrophage"], "Le PDF indique que les macrophages proviennent de la différenciation des monocytes.", 20],
        ["true_false", "La défense non spécifique est décrite comme immédiate et non propre à un antigène déterminé.", ["Vrai", "Faux"], ["Vrai"], "C’est la caractérisation donnée dans le document pour la défense innée non spécifique.", 30],
      ],
    },
    exerciseB: {
      title: "Exercice 2 — Défense spécifique et coopération cellulaire",
      difficulty: "medium",
      duration: 25,
      statement:
        "Comparez les réponses humorale et cellulaire puis expliquez la reconnaissance du soi, du non-soi et le rôle des lymphocytes.",
      solution:
        "La correction distingue plasmocytes et anticorps des lymphocytes T cytotoxiques, puis relie le CMH et la présentation antigénique à l’activation lymphocytaire.",
      questions: [
        ["single_choice", "Quel est l’effecteur de la réponse immunitaire humorale dans le document ?", ["Les anticorps circulants", "Les fibres musculaires", "Les ions sodium", "Les glandes salivaires"], ["Les anticorps circulants"], "La RIMH a pour point effecteur les anticorps sécrétés par les plasmocytes.", 10],
        ["single_choice", "Quelle molécule libérée par les lymphocytes T cytotoxiques permet la formation de pores et la cytolyse ?", ["La perforine", "L’aldostérone", "La rénine", "Le lysozyme"], ["La perforine"], "Le support décrit la perforine comme une substance qui s’incorpore à la membrane et crée des pores conduisant à la cytolyse.", 20],
        ["true_false", "Les lymphocytes B peuvent se différencier en plasmocytes producteurs d’anticorps et en lymphocytes B mémoire.", ["Vrai", "Faux"], ["Vrai"], "Ces deux devenirs sont explicitement donnés dans la phase de différenciation des lymphocytes B.", 30],
      ],
    },
    quiz: {
      title: "Quiz de révision — Défense de l’organisme",
      questions: [
        ["Comment appelle-t-on les molécules propres à l’individu qui permettent la reconnaissance de l’identité biologique ?", "Le document les désigne comme des marqueurs de l’identité biologique, dont le CMH.", ["Les marqueurs du soi", "Les toxines"], 10],
        ["Quel type de réaction est provoqué par la pénétration d’un corps étranger avant une réponse spécifique ?", "Le PDF décrit une réaction de défense innée, immédiate et non spécifique.", ["La défense non spécifique", "La réplication virale"], 20],
        ["Quel organe est cité comme lieu de maturation des lymphocytes T ?", "Le support indique que les lymphocytes T acquièrent leur maturité dans le thymus.", ["Le thymus", "Le bassinet"], 30],
        ["Quel terme désigne l’association formée par un antigène et un anticorps ?", "La réponse humorale conduit à la formation d’un complexe immun qui favorise la neutralisation de l’antigène.", ["Le complexe immun", "Le sarcomère"], 40],
      ],
    },
  },
];
...
const sql = `-- Brouillons SVT Terminale D : fonctionnement du cœur, maintien du milieu intérieur et défense de l’organisme.
  ...
  `${JSON.stringify(
    {
      ...
      name: "svt_terminale_d_coeur_milieu_interieur_defense_drafts",
      query: sql,
    },
    null,
    2,
