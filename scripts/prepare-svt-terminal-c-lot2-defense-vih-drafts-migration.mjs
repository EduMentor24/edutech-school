...
const applyInputPath = resolve(
  "supabase/migrations/20260821_svt_terminale_c_defense_vih_drafts.apply.json",
);
...
const lessons = [
  {
    id: "4127808a-f937-4d86-8c40-6205c7cd7d28",
    description:
      "Défense non spécifique et spécifique, barrières, phagocytose, réponse humorale, réponse cellulaire et coopération immunitaire.",
...
Contenu reformulé, structuré et approfondi à partir du PDF fourni : **« Le système de défense de l’organisme »**, SVT, Terminale C, Côte d’Ivoire — Mon École à la Maison.`,
    exerciseA: {
      ...
      duration: 15,
      statement:
        "Identifiez les barrières naturelles, la réaction inflammatoire et le rôle des phagocytes à partir de la situation de la piqûre d’épine.",
      solution:
        "La correction distingue les barrières, les signes de l’inflammation et les étapes décrites de la phagocytose.",
      questions: [
        ["single_choice", "Quel ensemble constitue la première ligne de défense de l’organisme dans le cours ?", ["La peau et les muqueuses", "Les plasmocytes uniquement", "Les virions", "Les LT4 uniquement"], ["La peau et les muqueuses"], "Le document présente la peau et les muqueuses comme des barrières naturelles constituant la première ligne de défense.", 10],
        ["single_choice", "Comment nomme-t-on la propriété par laquelle des cellules reconnaissent, englobent et digèrent des microbes ?", ["La phagocytose", "La cytolyse", "La greffe", "La transcription inverse"], ["La phagocytose"], "La phagocytose est définie dans le support comme la reconnaissance, l’englobement puis la digestion des microbes par des phagocytes.", 20],
        ["true_false", "La défense non spécifique décrite dans le cours est innée, immédiate et non propre à un antigène déterminé.", ["Vrai", "Faux"], ["Vrai"], "Le PDF formule explicitement ces trois caractéristiques de la défense non spécifique.", 30],
      ],
    },
    exerciseB: {
      title: "Exercice 2 — Immunité spécifique et coopération cellulaire",
      difficulty: "medium",
      duration: 20,
      statement:
        "Distinguez réponse humorale et réponse cellulaire, puis reliez les cellules et molécules à leurs rôles.",
      solution:
        "La correction associe plasmocytes et anticorps à la réponse humorale, ainsi que lymphocytes cytotoxiques et cytolyse à la réponse cellulaire.",
      questions: [
        ["single_choice", "Quelle cellule issue de la différenciation des lymphocytes B produit les anticorps ?", ["Le plasmocyte", "Le granulocyte", "Le LT4", "Le virion"], ["Le plasmocyte"], "Les plasmocytes sont les cellules issues des lymphocytes B qui produisent les anticorps dans la réponse humorale.", 10],
        ["single_choice", "Quel ensemble de protéines sériques peut être activé par le complexe antigène-anticorps selon le document ?", ["Le complément", "La myéline", "L’intégrase", "Le mucus"], ["Le complément"], "Le complément est décrit comme un ensemble de protéines du sérum activé par le complexe antigène-anticorps.", 20],
        ["true_false", "La réponse immunitaire à médiation cellulaire est présentée comme adaptée aux cellules hébergeant des virus ou d’autres parasites intracellulaires.", ["Vrai", "Faux"], ["Vrai"], "Le support relie la réponse cellulaire aux lymphocytes cytotoxiques et aux cellules porteuses de l’antigène, notamment lorsque celles-ci hébergent des virus.", 30],
      ],
    },
    quiz: {
      title: "Quiz de révision — Système de défense de l’organisme",
      questions: [
        ["Quel terme désigne une toxine microbienne atténuée qui conserve son pouvoir antigénique ?", "Une anatoxine est une toxine atténuée ayant perdu son pouvoir pathogène tout en conservant son pouvoir antigénique.", ["Une anatoxine", "Une toxémie"], 10],
        ["Que désigne le CMH dans cette leçon ?", "Le Complexe Majeur d’Histocompatibilité correspond à des protéines de surface liées à la reconnaissance du soi.", ["Un système de reconnaissance de l’identité biologique", "Une enzyme qui digère les bactéries"], 20],
        ["Quelle étape suit la reconnaissance de l’antigène dans l’organisation générale présentée ?", "Après la reconnaissance viennent l’activation, la différenciation et la multiplication des lymphocytes.", ["L’activation et la différenciation des lymphocytes", "La formation immédiate d’une greffe"], 30],
        ["Quelle notion résume l’action conjointe des macrophages, lymphocytes T et lymphocytes B ?", "Le document parle de coopération cellulaire lorsque macrophages, LT et LB participent ensemble à la réponse.", ["La coopération cellulaire", "La virémie"], 40],
      ],
    },
  },
  {
    id: "48ac83b1-aca3-41c2-b241-07617c08c438",
    description:
      "Structure du VIH, infection des LT4, évolution en trois phases, dysfonctionnement immunitaire et mesures de protection.",
    content: String.raw`## L’infection de l’organisme par le VIH
...
Contenu reformulé, structuré et approfondi à partir du PDF fourni : **« L’infection de l’organisme par le VIH »**, SVT, Terminale C, Côte d’Ivoire — Mon École à la Maison.`,
    exerciseA: {
      title: "Exercice 1 — Structure du VIH et infection du LT4",
      difficulty: "easy",
      duration: 15,
      statement:
        "Identifiez les éléments de la structure du VIH et organisez les premières étapes de l’infection du lymphocyte T4.",
      solution:
        "La correction mobilise les glycoprotéines d’enveloppe, le récepteur CD4, la transcriptase inverse et l’ADN proviral.",
      questions: [
        ["single_choice", "Quelle glycoprotéine du VIH se fixe au récepteur CD4 du LT4 selon le cours ?", ["Gp120", "Gp41", "IgG", "Perforine"], ["Gp120"], "Le document indique que Gp120 adhère aux récepteurs CD4 portés par les LT4.", 10],
        ["single_choice", "Quelle molécule est synthétisée à partir de l’ARN viral grâce à la transcriptase inverse ?", ["L’ADN proviral", "Un anticorps anti-VIH", "Le complément", "La myéline"], ["L’ADN proviral"], "La transcription inverse permet la synthèse de l’ADN proviral à partir de l’ARN viral.", 20],
        ["true_false", "L’intégrase permet l’intégration de l’ADN proviral dans l’ADN du LT4 dans le mécanisme présenté.", ["Vrai", "Faux"], ["Vrai"], "Le support cite explicitement l’intégrase pour l’intégration de l’ADN proviral à l’ADN du LT4.", 30],
      ],
    },
    exerciseB: {
      title: "Exercice 2 — Phases de l’infection et conséquences",
      difficulty: "medium",
      duration: 20,
      statement:
        "Interprétez l’évolution de la quantité de VIH, des LT4 et des anticorps anti-VIH au cours des trois phases décrites.",
      solution:
        "La correction distingue la primo-infection, la phase asymptomatique et la phase symptomatique, sans confondre séropositivité et SIDA déclaré.",
      questions: [
        ["single_choice", "Comment le document appelle-t-il la phase allant de 0 à 6 mois après la contamination ?", ["La primo-infection", "La phase de greffe", "La cytolyse", "La phase de phagocytose"], ["La primo-infection"], "Le support nomme primo-infection la première phase, de 0 à 6 mois.", 10],
        ["single_choice", "À quel moment le document qualifie-t-il l’individu de séropositif ?", ["Dès l’apparition des anticorps anti-VIH", "Dès la disparition totale des LT4", "Seulement au SIDA déclaré", "Avant toute contamination"], ["Dès l’apparition des anticorps anti-VIH"], "Le cours associe la séropositivité à l’apparition des anticorps anti-VIH.", 20],
        ["true_false", "Les maladies opportunistes citées dans le document sont reliées à l’affaiblissement du système immunitaire par la destruction des LT4.", ["Vrai", "Faux"], ["Vrai"], "La chute des LT4 conduit au dysfonctionnement du système immunitaire et à la vulnérabilité aux agents pathogènes.", 30],
      ],
    },
    quiz: {
      title: "Quiz de révision — Infection de l’organisme par le VIH",
      questions: [
        ["Quelle cellule est la cible du VIH dans le modèle étudié ?", "Le document indique que le VIH infecte les lymphocytes T4, qui portent le récepteur CD4.", ["Le lymphocyte T4", "Le plasmocyte"], 10],
        ["Quelle étape intervient après l’intégration de l’ADN proviral dans l’ADN du LT4 ?", "Le modèle place ensuite la transcription de l’ADN viral en ARN messager avant la synthèse de protéines virales.", ["La transcription en ARN messager viral", "La formation immédiate d’anticorps"], 20],
        ["Quel événement marque la sortie de nouveaux virions de la cellule hôte ?", "Le document décrit le bourgeonnement des virions, suivi de l’apparition de nouveaux virus.", ["Le bourgeonnement", "La phagocytose"], 30],
        ["Quelle conséquence générale résume la phase symptomatique ?", "La multiplication persistante du VIH et la chute des LT4 provoquent un dysfonctionnement immunitaire et une vulnérabilité aux maladies opportunistes.", ["Un dysfonctionnement du système immunitaire", "Une défense définitive contre tous les microbes"], 40],
      ],
    },
  },
];
...
const sql = `-- Brouillons SVT Terminale C : système de défense et infection par le VIH.
...
if (lessons.length !== 2) {
  throw new Error(`Deux leçons confirmées attendues ; ${lessons.length} préparées.`);
}
  ...
  `${JSON.stringify(
    {
      ...
      name: "svt_terminale_c_defense_vih_drafts",
      query: sql,
    },
    null,
    2,
