...
const migration = readFileSync(resolve(root, "supabase/migrations/20260824_publish_svt_terminal_drafts.sql"), "utf8");

describe("publication contrôlée des brouillons de SVT Terminale", () => {
  it("limite strictement la portée aux vingt-quatre brouillons SVT Terminale A1/A2/C/D", () => {
    expect(migration).toContain("target_count <> 24");
